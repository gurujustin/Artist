...
@section('content')
    ...
    <div class="page-content">
        ...
        <div class="content">
            ...
            <!-- ID CONTAINER -->
            <div id="container">
                <form action="{{ route('booking.edit', ['id' => $booking->id]) }}" method="POST">
                    @csrf
                    <!-- MY TABLE -->
                    <div class="row-fluid">
                        <div class="span12">
                                ...
                                <div class="grid-body ">
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-with-icon right">
                                                ...
                                                <input name="cname" id="cname" type="text"
                                                    value="{{ $booking->name }}" class="form-control" placeholder="NAME*">
                                            </div>
                                            @error('cname')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-with-icon right">
                                                ...
                                                <input name="email" id="email" type="text"
                                                    value="{{ $booking->email }}" class="form-control" placeholder="EMAIL*">
                                            </div>
                                            @error('email')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-with-icon right">
                                                ...
                                                <input name="tel" id="tel" type="text"
                                                    value="{{ $booking->tel }}" class="form-control" placeholder="TEL*">
                                            </div>
                                            @error('tel')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-with-icon right">
                                                <i class=""></i>
                                                <textarea name="venue" id="venue" type="text" class="form-control">{{ $booking->venue }}</textarea>
                                            </div>
                                            @error('venue')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-with-icon right">
                                                <i class=""></i>
                                                <textarea name="other" id="other" type="text" class="form-control">{{ $booking->other }}</textarea>
                                            </div>
                                            @error('other')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                        ...
                                        <div class="col-md-4">
                                            ...
                                            <div class="input-with-icon right">
                                                <i class=""></i>
                                                <input name="datetime" id="datetime" type="text" class="form-control" value="{{ $booking->datetime }}">
                                            </div>
                                            @error('datetime')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-danger btn-cons pull-left">UPDATE BOOKING DETAIL</button>
                        </div>
                    </div>
                </form>
