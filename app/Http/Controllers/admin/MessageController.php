...
class MessageController extends Controller
{
    ...
    public function send(Request $request){
        ...
        return redirect()->route('email')->with('The message was successfully sent.');
    }
    ...
    public function save(Request $request){
        ...
        return redirect()->action('admin\MessageController@draft')->with('message', 'The draft was successfully saved');
    }
