                                ...
                                <div class="grid-body ">
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-with-icon right">
                                                <i class=""></i>
                                                <input name="title" id="title" type="text" class="form-control" placeholder="title*" value="" >
                                            </div>
                                            @error('title')
                                                <span class="error">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            ...
                                            <div class="input-with-icon right">
                                                <i class=""></i>
                                                <input name="image" id="image" type="file" class="form-control" placeholder="image*" value="" accept=".jpg, .png, .jpeg, .svg">
                                            </div>
                                            @error('image')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            ...
                                            <textarea id="text-editor" name="description"  class="form-control" rows="10"></textarea>
                                            @error('description')
                                                <span class="error">
                                                    <strong>{{ $message }}</strong>
                                                </span>
