                        ...
                        <div class="pull-left">
                            <div class="btn-group">
                                ...
                                <ul class="dropdown-menu">
                                    ...
                                    <li><a href="{{ action('admin\MessageController@reply', ['id' => $message->id]) }}">Reply</a></li>
                                    @endif
                                    <li><a href="{{ action('admin\MessageController@singletrash', ['id' => $message->id]) }}">Move to Trash</a></li>
                                    @else
                                    <li><a href="{{ action('admin\MessageController@singlerecover', ['id' => $message->id]) }}">Recover</a></li>
                                    <li><a href="{{ action('admin\MessageController@singledelete', ['id' => $message->id]) }}">Forever Delete</a></li>
                                    @endif
                                </ul>
                            </div>
