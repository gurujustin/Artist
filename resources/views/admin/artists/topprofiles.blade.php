                ...
                <div class="span12">
                    <div class="grid simple ">
                        <div class="grid-title">
                            <h4>
                                <span class="semi-bold">Top Profiles</span>
                            </h4>
                        </div>
                        <span class="refresh">
                            <div class="grid-body ">
                                            ...
                                            <td style="text-align: center">
                                                <div class="btn-group">
                                                    ...
                                                    <ul class="dropdown-menu">
                                                        <li><a href="{{ route('artists.detail', ['artist' => $profile->user->id, 'profileid' => $profile->id]) }}" target="_ba">View Profile</a></li>
                                                        <li><a
                                                        ...
                                                        <li>
                                                            <a
                                                                onclick="document.getElementById('block{{ $profile->id }}').submit();">Block
                                                                profile</a>
                                                            <form
                                                        ...
                                                        <li>
                                                            <a
                                                                onclick="document.getElementById('upgrade{{ $profile->id }}').submit();">Remove
                                                                from TOP</a>
                                                            <form
                                                                action="{{ action('admin\ProfileController@downgradeprofile', ['id' => $profile->id]) }}"
                                                                method="POST" id="upgrade{{ $profile->id }}">
                                                                @csrf
                                                            </form>
                                                        </li>
                                                    </ul>
