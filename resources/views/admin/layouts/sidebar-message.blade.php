...
<div class="inner-menu nav-collapse ">
    <div class="inner-wrapper">
        <a href="{{ action("admin\MessageController@create") }}" class="btn btn-block btn-primary"><span class="bold">COMPOSE</span></a>
    ...
    <ul class="big-items message-tab">
        <li><span class="badge badge-important">{{ count(App\Models\Message::where('to', Auth::user()->email)->where('trashed', 0)->where('checked', 0)->get()) }}</span><a href="{{ action("admin\MessageController@index") }}"> Inbox</a></li>
        ...
        <li><span class="badge badge-important">{{ count(App\Models\Message::where('trashed', 1)->where('owner', 0)
            ...
            })->get()) }}</span><a href="{{ action("admin\MessageController@trash") }}">Trash</a></li>
    </ul>
</div>
<!-- END SIDEBAR -->